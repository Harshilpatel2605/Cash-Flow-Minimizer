  ...
  minimizeCashFlow() {
    ...
    while (numZeroNetAmounts !== this.banks.length) {
      ...
      if (maxIndex === -1) {
        ...
        ansGraph[minIndex][0].paymentType = Array.from(this.banks[minIndex].types)[0];
        ...
        ansGraph[0][simpleMaxIndex].paymentType = Array.from(this.banks[simpleMaxIndex].types)[0];
